...
public class VulnsBriefListAdapter extends BaseAdapter {
	...
	public VulnsBriefListAdapter(Context context, ArrayList<VulnBriefResult> vulnResult) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vh = new ViewHolder();
			convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_vuln_brief, parent, false);
